...
PUBLIC_KEY = 'f8a75f5916a235494640dbe7fa96367e'
PRIVATE_KEY = '0495a20f72c7eae7ff7e06925cc9ed739c974b3e'
TS = 1
...
def get_comics(request):
    ...
    for i in range(len(id)):
        ...
        <input type="text" name="offset" value="{offset + 1}" style="visibility: hidden">
        </form>
        </footer>
            </td>
            </div>
